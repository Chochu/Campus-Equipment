   ...
   <nav class="navbar navbar-inverse">
     <div class="container-fluid">
       ...
       <ul class="nav navbar-nav">
         ...
         <li class="dropdown Active"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Equipment Type<span class="caret"></span></a>
           <ul class="dropdown-menu">
             <li><a href="InsertEquipmentType.php">Insert EquipmentType</a></li>
             <li><a href="LookupEquipmentType.php">Lookup Equipment Type</a></li>
             <li><a href="DeleteEquipmentType.php">Delete Equipment Type</a></li>
             <li><a href="UpdateEquipmentType.php">Update Equipment Type</a></li>
           </ul>
         </li>
